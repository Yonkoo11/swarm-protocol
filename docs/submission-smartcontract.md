...
## What I Built
A 421-line Solidity contract (SwarmCoordinator) deployed on Base Sepolia with:
...
- Double-vote prevention on juror voting (hasVoted mapping)
- Jury fee remainder handling (no dust stuck in contract)
- 17 passing Foundry tests covering happy paths, disputes, access control, task trees, and edge cases
...
- **Verified**: [Sourcify (exact match)](https://sourcify.dev/#/lookup/0xec8419C9F4509d5e83E4329721cFCb9f27f6B649) | [Blockscout](https://base-sepolia.blockscout.com/address/0xec8419C9F4509d5e83E4329721cFCb9f27f6B649)
- **Live frontend**: https://hivemind-swarm.netlify.app
- **Demo transactions**:
  - [Create Task #1 - USDC analysis (2 USDC)](https://sepolia.basescan.org/tx/0xa6117e299d9720bb72fcda2de19ad92b87782009c904196a566ffd8f3f1b3752)
  - [Create Task #2 - CCTP analysis (1 USDC)](https://sepolia.basescan.org/tx/0xfefecf060a3a878777d04922648cbb576d63219d0dd9859e68a41166f5ab801e)
  - [Create Task #3 - Price feed (1 USDC)](https://sepolia.basescan.org/tx/0xe67fca8ff93d097e59f70c7eac32673e7f20e7abf3db6b7a639b7a1f3dde125e)
- **Tests**: 17/17 passing (create, claim, submit, approve, cancel, dispute-assignee-wins, dispute-creator-wins, task decomposition, double-vote prevention, insufficient jurors, 5 access control reverts)
